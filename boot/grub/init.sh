...
then
  ...
  then
    ...
    for boot_path in /efi/centos/grubx64.efi /boot/efi/ubuntu/grubx64.efi /efi/ubuntu/grubx64.efi /boot/efi/debian/grubx64.efi /EFI/debian/grubx64.efi /boot/EFI/debian/shimx64.efi /EFI/debian/shimx64.efi /EFI/fedora/grubx64.efi /EFI/opensuse/grubx64.efi /EFI/redhat/grubx64.efi /EFI/boot/bootx64.efi; do
